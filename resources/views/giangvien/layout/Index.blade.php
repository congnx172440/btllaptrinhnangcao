...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="giangvien/giangvien/thongtin/{{Auth::user()->id}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="giangvien/sinhvien/chon/{{Auth::user()->giangvien->id}}"  >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="giangvien/tintuc/danhsach/{{Auth::user()->id}}" >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="giangvien/tinnhancho/danhsach"  >
                      ...
                      <!-- Nav Item - User Information -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="giangvien/giangvien/thongtin/{{Auth::user()->id}}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Thông tin
                                </a>
                                <a class="dropdown-item" href="giangvien/giangvien/sua/{{Auth::user()->giangvien->id}}">
