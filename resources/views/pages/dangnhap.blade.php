                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block ">
                            <img src="../admin_asset/img/c9_bachkhoalogo.jpg" style="width: 85%; height: 100%">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <a class="small" href="themkhach">Chưa có tài khoản? Đăng ký</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="trangchu">Về trang tin tức chính</a>
                                </div>
                                @if(count($errors)>0)
...
<script src="../public/admin_asset/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript-->
<script src="../public/admin_asset/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for all pages-->
<script src="../public/admin_asset/js/sb-admin-2.min.js"></script>
