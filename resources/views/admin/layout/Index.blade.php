...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin/giangvien/thongtin/{{Auth::user()->id}}">
            ...
            <!-- Nav Item - Vị trí công tác Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/vitri/danhsach" >
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Vị trí công việc</span>
                </a>
            </li>

            <!-- Nav Item - Khóa học Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/khoahoc/danhsach"  >
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Khóa học</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/lophoc/danhsach"  >
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Lớp học</span>
                </a>
            </li>

            <!-- Nav Item - Loại tin Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/loaitin/danhsach"  >
                    <i class="fas fa-fw fa-cog"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/khach/danhsach"  >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/giangvien/chon"  >
                    <i class="fas fa-fw fa-wrench"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/sinhvien/chon"  >
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Tài khoản sinh viên</span>
                </a>
            </li>

            <!-- Nav Item - Quản lý tài khoản lãnh đạo Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/lanhdao/danhsach"  >
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Tài khoản lãnh đạo</span>
                </a>
            </li>
            <!-- Nav Item - Tin tức Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/tintuc/danhsach"  >
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Tin tức</span>
                </a>
            </li>

            <!-- Nav Item - Tuyển Sinh Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/tuyensinh/danhsach"  >
                    <i class="fas fa-fw fa-folder"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/tinnhancho/danhsach"  >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="admin/thongke/danhsach"  >
                      ...
                      <!-- Nav Item - User Information -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="admin/giangvien/thongtin/{{Auth::user()->id}}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Thông tin
                                </a>
                                <a class="dropdown-item" href="admin/giangvien/sua/{{Auth::user()->id}}">
