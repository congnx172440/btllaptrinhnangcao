...
@section('content')
    ...
    <div class="text-center">
        <h1 class="h4 text-gray-900 mb-4">THÊM MỚI LỚP HỌC</h1>
    </div>
    <form class="user" action="admin/lophoc/them" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user"
                   placeholder="Nhập tên lớp học" name="ten_lop_hoc">
        </div>
        <div class="form-group">
            ...
            <select class="form-control" style="font-size: 0.8rem;border-radius: 10rem;height: 3.1rem;"
                ...
                @foreach($khoahoc as $tl)
                    <option value="{{$tl->id}}">{{$tl->nien_khoa}}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
