...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="lanhdao/giangvien/thongtin/{{Auth::user()->id}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="lanhdao/tinnhancho/danhsach"  >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="lanhdao/thongke/danhsach"  >
                      ...
                      <!-- Nav Item - User Information -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="lanhdao/giangvien/thongtin/{{Auth::user()->id}}">
