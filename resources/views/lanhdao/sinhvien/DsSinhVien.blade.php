...
@section('content')
    <div style="margin-bottom:10px" class="col-sm-12">
        <a href="lanhdao/sinhvien/them/{{$id}}">
                ...
                <table class="text-center table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach ($sinhvien as $tl)
                        <tr>
                            ...
                            <td><a href="lanhdao/sinhvien/xoa/{{$tl->id}}"><i class="far fa-trash-alt"></i></a></td>
                            <td><a href="lanhdao/sinhvien/sua/{{$tl->id}}"><i class="far fa-edit"></i></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
