...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="sinhvien/thongtin/{{Auth::user()->id}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="sinhvien/thongtin/{{Auth::user()->id}}"  >
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Tài khoản </span>
                </a>
            </li>

            <!-- Nav Item - Danh sách sinh viên  Menu -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Sửa thông tin Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="sinhvien/sua/{{Auth::user()->sinhvien->id}}" >
                    <i class="fas fa-fw fa-wrench"></i>
                      ...
                      <!-- Nav Item - User Information -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="sinhvien/thongtin/{{Auth::user()->id}}">
